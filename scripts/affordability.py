...
if not is_renter:
    # Fix: Use markdown with HTML to allow styling/bolding and added margin-top for space
    st.markdown(f"""
        <p style="font-size: 0.85em; color: {SLATE_ACCENT}; margin-top: 7.5px; margin-bottom: 7.5px;">
