...
# SMART FIX: We strip whitespace and ensure capitalization for the check
...
with col_2:
    ...
    target_city = "Other/Outside Toronto"
    # Ensure strict checking against the clean province variable
    if province == "Ontario":
...
if max_pi_stress > 0:
    ...
    # Pass the clean province and target_city variables
