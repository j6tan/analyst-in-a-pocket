...
if aff_sec.get('target_price', 0) == 0:
    aff_sec.update({"down_payment": 200000.0, "target_price": 600000.0, "contract_rate": 4.26, "manual_rent": 2500.0, "vacancy_months": 1.0, "annual_prop_tax": 3000.0, "strata_mo": 400.0, "insurance_mo": 100.0, "rm_mo": 150.0, "asset_province": current_res_prov, "use_case": "Rental Property", "mgmt_pct": 5.0, "is_vanc": False})
...
with c_left:
    ...
    # --- LIVE MAX QUALIFYING POWER (Using your 80% Rental Offset) ---
...
# --- 12. CONCISE INSIGHTS & STRESS TEST ---
st.write("")
