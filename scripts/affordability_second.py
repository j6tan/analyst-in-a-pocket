...
with c_left:
    ...
    store['target_price'] = st.number_input(f"Maximum Buying Power (Qualified: ${max_buying_power:,.0f})", 
...
with c_right:
    ...
    ann_tax = st.number_input("Annual Property Tax ($)", value=float(calc_tax))
