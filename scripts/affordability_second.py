...
if "aff_second_store" not in st.session_state:
    ...
    st.session_state.aff_second_store = {
        ...
        "rm_mo": 150.0,
        "mgmt_pct": 5.0,
        "annual_prop_tax": init_price * 0.0031
    }
store = st.session_state.aff_second_store

# --- 4. TITLE & STORYTELLING BOX ---
...
with c_left:
    ...
    if new_price != store['target_price']:
        ...
        # Optional: update tax/rent only if they haven't been manually overridden? 
        # For now, we prioritize persistence of existing store values.
