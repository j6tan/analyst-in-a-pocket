...
with c1:
    st.markdown(f"""
    <div style="background-color: white; padding: 25px; border-radius: 12px; border: 1px solid {BORDER_GREY}; height: 100%; min-height: 420px; display: flex; flex-direction: column;">
        <h3 style="color: {SLATE_ACCENT}; margin-top: 0; font-size: 1.2em;">48-Hour Weekend Pass</h3>
        <h1 style="color: {CHARCOAL}; font-size: 2.5em; margin: 10px 0px;">$4.99<span style="font-size: 0.4em; color: #6c757d;"> CAD one-time</span></h1>
...
with c2:
    st.markdown(f"""
    <div style="background-color: {OFF_WHITE}; padding: 25px; border-radius: 12px; border: 3px solid {PRIMARY_GOLD}; position: relative; height: 100%; min-height: 420px; display: flex; flex-direction: column; transform: scale(1.03); box-shadow: 0 10px 20px rgba(0,0,0,0.05);">
        ...
        <h1 style="color: {CHARCOAL}; font-size: 2.8em; margin: 10px 0px;">$9.99<span style="font-size: 0.35em; color: #6c757d;"> CAD / mo</span></h1>
...
with c3:
    ...
    <div style="background-color: white; padding: 25px; border-radius: 12px; border: 1px solid {BORDER_GREY}; height: 100%; min-height: 420px; display: flex; flex-direction: column;">
        ...
        <h1 style="color: {CHARCOAL}; font-size: 2.5em; margin: 10px 0px;">$299<span style="font-size: 0.4em; color: #6c757d;"> CAD one-time</span></h1>
        <p style="color: #6c757d; font-size: 0.9em; flex-grow: 1;">
